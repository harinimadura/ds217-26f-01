...
# 10. print the summary labels shown below using print() with comma-separated values. The supplied data gives a mean of 20.5; no rounding or text formatting is needed.
